...
from tribev2.eventstransforms import ExtractWordsFromAudio as _ExtractWordsFromAudio


def _patched_get_transcript_from_audio(wav_filename: _Path, language: str) -> _pd.DataFrame:
    import json
    import os
    import subprocess
    import tempfile
...
_ExtractWordsFromAudio._get_transcript_from_audio = staticmethod(
